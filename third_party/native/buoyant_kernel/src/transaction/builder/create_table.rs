...
use crate::schema::{
    DataType, SchemaRef, StructType, normalize_column_names_to_schema_casing,
    schema_contains_non_null_fields,
};
use crate::table_configuration::TableConfiguration;
#[cfg(feature = "nanosecond-timestamps")]
use crate::table_features::schema_contains_timestamp_nanos;
use crate::table_features::{
    ColumnMappingMode, SET_TABLE_FEATURE_SUPPORTED_PREFIX, SET_TABLE_FEATURE_SUPPORTED_VALUE,
    TableFeature, add_feature_to_lists, assign_column_mapping_metadata,
    auto_enable_property_driven_features, find_max_column_id_in_schema,
    get_any_level_column_physical_name, get_column_mapping_mode_from_properties,
    schema_contains_timestamp_ntz,
};
use crate::table_properties::{
    APPEND_ONLY, CHECKPOINT_INTERVAL, CHECKPOINT_WRITE_STATS_AS_JSON,
    ...
    SET_TRANSACTION_RETENTION_DURATION, TableProperties,
};
...
mod tests {
    ...
    use crate::schema::{
        ColumnMetadataKey, DataType, MetadataValue, StructField, StructType, schema_ref,
    };
