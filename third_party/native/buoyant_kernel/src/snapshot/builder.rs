...
impl SnapshotBuilder {
    ...
    pub fn build(self, engine: &dyn Engine) -> DeltaResult<SnapshotRef> {
        let _resource_guard = crate::resource::enter_resource_scope(
...
mod tests {
    ...
    use serde_json::json;
    use test_utils::{TestAction, actions_to_string, add_commit};
    ...
    use crate::utils::test_utils::{CapturingReporter, install_thread_local_metrics_reporter};
    ...
    mod catalog_managed_tests {
        use test_utils::{
            TestAction, actions_to_string, actions_to_string_catalog_managed, add_commit,
            add_staged_commit,
        };
