...
async fn get_data_scan_plan(
    ...
    let to_partitioned_file = |(file_index, f): (usize, ScanFileContext)| {
        ...
        // Keep the original decoded statistics/schema owner with this file plan.
        // Extension-map bookkeeping admission is separate from this lifetime transfer.
        partitioned_file.extensions.insert_arc(f.native_batch);
