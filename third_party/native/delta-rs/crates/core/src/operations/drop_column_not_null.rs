...
use crate::kernel::{
    Action, EagerSnapshot, ProtocolExt as _, SnapshotMetadataRef,
    resolve_snapshot,
};
...
fn plan_drop_column_not_null_actions(
    ...
    metadata = metadata.with_schema(crate::kernel::models::actions::admitted_schema_arc(updated_table_schema)?)?;
