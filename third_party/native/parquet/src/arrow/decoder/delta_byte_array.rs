...
impl DeltaByteArrayDecoder {
    ...
    pub fn new(data: Bytes) -> Result<Self> {
        ...
        let mut prefix_lengths =
            crate::resource::vec_with_capacity(num_prefix, "delta prefix suffix lengths")?;
        prefix_lengths.resize(num_prefix, 0);
        ...
        let mut suffix_lengths =
            crate::resource::vec_with_capacity(num_suffix, "delta prefix suffix lengths")?;
        suffix_lengths.resize(num_suffix, 0);
