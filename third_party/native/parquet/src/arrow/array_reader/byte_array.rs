    ...
    fn consume_batch(&mut self) -> Result<ArrayRef> {
        ...
        let array: ArrayRef = match self.data_type {
            ...
            ArrowType::Decimal128(p, s) => {
                let array = buffer.try_into_array(null_buffer, ArrowType::Binary)?;
            ...
            _ => buffer.try_into_array(null_buffer, self.data_type.clone())?,
        };
...
impl<I: OffsetSizeTrait> ColumnValueDecoder for ByteArrayColumnValueDecoder<I> {
    ...
    fn set_dict(
        ...
        let mut buffer = OffsetBuffer::try_with_capacity(0)?;
...
impl ByteArrayDecoderPlain {
    ...
    pub fn read<I: OffsetSizeTrait>(
        ...
        crate::resource::reserve_vec(&mut output.offsets, to_read, "byte array offsets")?;
        ...
        crate::resource::reserve_vec(&mut output.values, estimated_bytes, "byte array estimate")?;
...
impl ByteArrayDecoderDeltaLength {
    fn new(data: Bytes, validate_utf8: bool) -> Result<Self> {
        ...
        let mut lengths = crate::resource::vec_with_capacity(values, "delta byte array lengths")?;
    ...
    fn read<I: OffsetSizeTrait>(
        ...
        crate::resource::reserve_vec(&mut output.offsets, to_read, "byte array offsets")?;
        crate::resource::reserve_vec(&mut output.values, total_bytes, "delta byte array values")?;
...
impl ByteArrayDecoderDelta {
    ...
    fn read<I: OffsetSizeTrait>(
        ...
        crate::resource::reserve_vec(
            &mut output.offsets,
            len.min(self.decoder.remaining()),
            "delta byte array offsets",
        )?;
...
impl ByteArrayDecoderDictionary {
    ...
    fn read<I: OffsetSizeTrait>(
        ...
        crate::resource::reserve_vec(&mut output.offsets, len, "dictionary expanded offsets")?;
