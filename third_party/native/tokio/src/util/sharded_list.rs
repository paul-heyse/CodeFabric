...
pub(crate) fn resource_heap_bytes<L: ShardedListItem>(shards: usize) -> Result<usize, crate::runtime::resource::ResourceLayoutError> {
    crate::runtime::resource::array_bytes::<Mutex<LinkedList<L>>>(shards)
}
