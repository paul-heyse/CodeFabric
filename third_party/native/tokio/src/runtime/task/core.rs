...
pub(super) struct Cell<T: Future, S> {
    ...
    pub(super) resource_receipt:
        Option<std::sync::Arc<dyn crate::runtime::resource::RuntimeAllocationReceipt>>,
}
...
impl<T: Future, S: Schedule> Cell<T, S> {
    ...
    pub(super) fn new(
        ...
        let result = Box::new(Cell {
            #[cfg(all(feature = "rt-multi-thread", feature = "time"))]
            resource_receipt: crate::runtime::resource::take_task_receipt(),
