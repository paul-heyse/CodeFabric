...
pub(crate) fn resource_heap_bytes<S: 'static>(workers: usize) -> Result<usize, crate::runtime::resource::ResourceLayoutError> {
    crate::util::sharded_list::resource_heap_bytes::<Task<S>>(OwnedTasks::<S>::gen_shared_list_size(workers))
}
