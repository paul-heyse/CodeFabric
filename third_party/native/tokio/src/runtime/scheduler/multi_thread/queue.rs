...
#[cfg(feature = "time")]
pub(super) fn resource_heap_bytes() -> Result<usize, crate::runtime::resource::ResourceLayoutError> {
    use crate::runtime::resource::{add, arc_bytes, array_bytes};
    type Slot = crate::loom::cell::UnsafeCell<std::mem::MaybeUninit<crate::runtime::task::Notified<Arc<super::Handle>>>>;
    add(arc_bytes::<Inner<Arc<super::Handle>>>()?, array_bytes::<Slot>(LOCAL_QUEUE_CAPACITY)?)
}
