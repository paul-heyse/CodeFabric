...
pub(super) fn resource_heap_bytes() -> Result<usize, crate::runtime::resource::ResourceLayoutError> { crate::runtime::resource::add(crate::runtime::resource::arc_bytes::<oneshot::Sender<()>>()?, oneshot::resource_heap_bytes::<()>()?) }
