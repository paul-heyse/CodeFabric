...
pub struct SchemaBuilder {
    ...
    resource_owner: crate::resource::ResourceOwnerHandle,
}
...
impl SchemaBuilder {
    ...
    pub fn with_capacity(capacity: usize) -> Self {
        Self {
            ...
            resource_owner: crate::resource::ResourceOwnerHandle::capture(),
        }
    }
    ...
    pub fn finish(self) -> Schema {
        let mut fields: Fields = self.fields.into();
        fields.transfer_resource_owner(self.resource_owner);
        Schema {
            fields,
...
impl From<&Fields> for SchemaBuilder {
    fn from(value: &Fields) -> Self {
        Self {
            fields: value.to_vec(),
            metadata: Default::default(),
            resource_owner: value.resource_owner().clone(),
        }
    }
}
...
impl From<Schema> for SchemaBuilder {
    fn from(value: Schema) -> Self {
        Self {
            resource_owner: value.fields.resource_owner().clone(),
...
impl Schema {
    ...
    pub fn project(&self, indices: &[usize]) -> Result<Schema, ArrowError> {
        ...
        let mut new_fields: Fields = new_fields.into();
        new_fields.try_inherit_resource_owner(self.fields.resource_owner())?;
    ...
    pub fn try_merge(schemas: impl IntoIterator<Item = Self>) -> Result<Self, ArrowError> {
        ...
        for schema in schemas {
            ...
            out_fields
                .resource_owner
                .try_inherit(fields.resource_owner())?;
    ...
    pub fn normalize(&self, separator: &str, max_level: Option<usize>) -> Result<Self, ArrowError> {
        ...
        let mut fields: Fields = fields.into();
        fields.try_inherit_resource_owner(self.fields.resource_owner())?;
