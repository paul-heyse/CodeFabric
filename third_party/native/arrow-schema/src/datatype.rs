...
mod tests {
    ...
    fn size_should_not_regress() {
        // Fields/UnionFields now retain an inline metadata lifetime root.
        // Keep the prior native representation and the explicit handle cost
        // separately visible; this is not a blanket size-regression exemption.
        assert_eq!(
            std::mem::size_of::<DataType>(),
            24 + std::mem::size_of::<crate::resource::ResourceOwnerHandle>()
        );
    }
