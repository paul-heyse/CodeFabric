...
predecessor_path: docs/authoritative_design/code_property_graph_semantic_query_specification_v2.1.md
---

# Composable Semantic Query Specification v2.2
...
The v2.1 predecessor is immutable release history. V2.2 preserves the eight request-form names,
