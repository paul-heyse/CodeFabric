...
predecessor_path: docs/authoritative_design/present_state_cpg_fastmcp_serving_specification_v2.0.md
---

# Present-State CPG FastMCP Serving Specification v2.1
...
The v2.0 predecessor is immutable release history. V2.1 preserves its Protobuf service method
...
part of the local v2.1 profile.
...
programmatic-assembly/release/proof fields only in the negotiated v2 profile. Status is a projection of the
