...
artifact_id: CF-ONT-2.1.0
suite_id: codefabric-relational-data-fabric
suite_version: 2.1.0
artifact_tag: ONT
artifact_version: 2.1.0
authority_status: current
predecessor_path: docs/authoritative_design/code_property_graph_present_state_fact_ontology_specification_v2.0.md
---

# Code Property Graph present-state fact ontology specification v2.1

## 0. Governing contract and transition status

The stable artifact identity is `CF-ONT-2.1.0`. Together with the other current
`codefabric-relational-data-fabric` v2.1 masters, this artifact is the sole current ontology
authority. Its v2.0 predecessor is immutable historical evidence, not a coequal runtime or
authoring authority.
...
hand-maintained traceability as semantic authorities. Until the v2.1 runtime cutover proves and
