...
predecessor_path: docs/authoritative_design/code_property_graph_semantic_query_specification_v2.0.md
---

# Composable Semantic Query Specification v2.1
...
The v2.0 predecessor is immutable release history. V2.1 preserves the eight request-form names,
...
remain supported through explicit handshake negotiation; a v2.1 implementation MUST NOT silently
