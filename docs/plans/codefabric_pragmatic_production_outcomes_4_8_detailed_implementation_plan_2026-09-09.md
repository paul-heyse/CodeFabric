...
Created 2026-09-09 against `126cf71f`; progress reconciled 2026-09-09 against the canonical `master` tree through production commit `7cc76a00` (`Share captured Rust toolchain inputs across target preparation`) and the Cargo library-linkage change under validation in STATUS.
