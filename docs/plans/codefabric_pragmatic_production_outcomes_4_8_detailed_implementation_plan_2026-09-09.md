...
Created 2026-09-09 against `126cf71f`; progress reconciled 2026-09-09 against the canonical `master` tree through production commit `9cc99f76` (`Scope outgoing Rust call coverage to admitted caller bodies`) and the captured Cargo platform-selection change recorded in STATUS.
