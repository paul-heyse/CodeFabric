...
Created 2026-09-09 against `126cf71f`; progress reconciled 2026-09-09 against the canonical `master` tree through production commit `d07d81e4` (`Expose checked UTF-8 and UTF-16 source-context columns`) and the surrounding-line change described in STATUS.
