...
Created 2026-09-09 against `126cf71f`; progress reconciled 2026-09-09 against the canonical `master` tree through production commit `46a7a412` (`Admit exact Cargo library linkage and preserve compiler crate types`) and the captured feature/profile change under validation in STATUS.
