...
# CodeFabric Waves 4–7 Core Facts — Implementation Plan v2
...
| docs/upfront_design/present_state_cpg_data_fabric_specification_rust_arrow_datafusion_deltalake_v1.3.md | 0a1574d65e176031156f62989c509cf663e83558122fb8c684e98ddfa13d49b3 |
...
DB07–DB09. Before WP27 begins it SHALL also make this v2
...
- **D-42 — Active-plan adoption is a stop gate.** The first executor action creates
  schema-2 state, points generic plan tooling at v2, and proves explicit and default
...
|---|---|---|---|---|
| F-001 | applied; adoption-gated | Plan §3, §14, §16 | v2 adoption is an explicit pre-WP27 stop gate; integration never fabricates execution state | exact command exit 1 at predecessor-default `artifacts-check`, as expected before state/active-plan adoption |
...
- [ ] §3 adoption — schema-2 state exists; explicit/default artifact validation,
      status, and active-plan tests resolve this v2 plan
