...
working_tree_digest: 37d862171dfa9e3c5b3521df4bab9a15029d628375a2c706467394b88f6de498
predecessor_plan_path: docs/plans/codefabric_real_time_cpg_implementation_plan_v1_2026-09-04.md
approval_basis: User authorized implementation of the entire v1 plan on 2026-09-04.
...
# Complete real-time Python/Rust CPG — implementation plan v2
...
This approval revision preserves v1's complete design, work packets, stable IDs, dependencies and proof obligations. The user authorized full execution on 2026-09-04. Only the approval/activation metadata and corresponding explanatory text change: the existing activation validator requires a whole-worktree inventory, whereas v1 recorded the review's implementation-scoped digest. V1 remains immutable history and a declared input.
...
Future state path: `docs/plans/state/codefabric-real-time-cpg_v2_state.json`; schema version 2. Creation occurs only through the validated activation transaction.
...
plan = ROOT / "docs/plans/codefabric_real_time_cpg_implementation_plan_v2_2026-09-04.md"
...
PY
just plan-dependency-check docs/plans/codefabric_real_time_cpg_implementation_plan_v2_2026-09-04.md
```
...
This is the **approved activation revision** of the user's v1 implementation request. It does not claim implementation results. The next action is validated activation and dependency-ordered execution under impl-plan-exec. V1 and the design corpus remain immutable; no production or dependency change is made merely by creating this revision.
