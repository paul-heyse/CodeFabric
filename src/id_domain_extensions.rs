// Application-owned released Arrow ID extensions and DataFusion registrations.
...
fn attach_id_domain(field: Field, domain: &str) -> Result<Field, ArrowError> {
    match domain {
