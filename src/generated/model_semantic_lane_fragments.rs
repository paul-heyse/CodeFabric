...
pub const SEMANTIC_INGEST_CONTRACTS: &[SemanticIngestContract] = &[
    ...
    SemanticIngestContract {
        contract_id: "INGEST_SHARED_FACT_SUBSTRATE_RUFF_V2",
        lane: SemanticLane::Shared,
        observation_schema_ids: &["codefabric.ruff.semantic.v2"],
        output_table_codes: &[100, 110, 130],
        required_fields: &["entity_id", "fact_id", "evidence_id"],
    },
    SemanticIngestContract {
        contract_id: "INGEST_SHARED_FACT_SUBSTRATE_RUFF_V3",
        lane: SemanticLane::Shared,
        observation_schema_ids: &["codefabric.ruff.semantic.v3"],
        output_table_codes: &[100, 110, 130],
        required_fields: &["entity_id", "fact_id", "evidence_id"],
    },
    SemanticIngestContract {
    ...
    SemanticIngestContract {
        contract_id: "INGEST_RUFF_SEMANTIC_CFG_V2",
        lane: SemanticLane::Python,
        observation_schema_ids: &["codefabric.ruff.semantic.v2"],
        output_table_codes: &[
            10, 100, 110, 130, 200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300,
        ],
        required_fields: &[
            "module_name",
            "provider_image_fingerprint",
    ...
    SemanticIngestContract {
        contract_id: "INGEST_RUFF_SEMANTIC_DATAFLOW_V3",
        lane: SemanticLane::Python,
        observation_schema_ids: &["codefabric.ruff.semantic.v3"],
        output_table_codes: &[
            10, 100, 110, 130, 200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300, 310, 320,
            330, 340, 350,
        ],
        required_fields: &[
            "module_name",
            ...
            "values_json",
            "operations_json",
            "dataflow_events_json",
            "memory_locations_json",
            "access_path_components_json",
            "dataflow_relations_json",
        ],
    },
    SemanticIngestContract {
...
pub const SEMANTIC_INVALIDATION_CONTRACTS: &[SemanticInvalidationContract] = &[
    ...
    SemanticInvalidationContract {
        ...
        lane: SemanticLane::Python,
        trigger_kinds: &["python-source-change", "python-manifest-change"],
        invalidated_table_codes: &[
            10, 200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300, 310, 320, 330, 340, 350,
        ],
        scope: "module-owner-and-analysis-context",
    },
    SemanticInvalidationContract {
