    ...
    fn field_specs(self) -> Vec<FieldSpec> {
        ...
        let specific = match self {
            ...
            Self::Type => vec![
                ...
                u64_field("array_length", true),
                utf8("region_kind", true),
                u64_field("bound_variable_count", false),
                utf8("function_abi", true),
                bool_field("function_abi_unwind", true),
                bool_field("function_unsafe", true),
                bool_field("function_variadic", true),
            ],
            Self::Instance => vec![
