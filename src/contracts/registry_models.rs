...
pub fn validate_error_records(records: &[PublicError]) -> Result<(), String> {
    ...
    exact_names(
        ...
        &[
            ...
            "INTERNAL",
            "INVALID_EPOCH_RESOURCE_POLICY",
            "INVALID_EPOCH_WORK_CLASS_POLICY",
            "EPOCH_RESOURCE_PIN_MISMATCH",
            "EPOCH_RESOURCE_BACKPRESSURE",
            "EPOCH_RESOURCE_DEADLINE_EXCEEDED",
            "EPOCH_RESULT_LEASE_BACKPRESSURE",
            "EPOCH_RESOURCE_COUNTER_OVERFLOW",
            "RESULT_ARTIFACT_IDENTITY_COLLISION",
            "RESULT_ARTIFACT_UNKNOWN",
            "RESULT_EPOCH_PIN_MISMATCH",
            "RESULT_RESOURCE_UNKNOWN",
        ],
        "public-error",
    )?;
    for record in records {
