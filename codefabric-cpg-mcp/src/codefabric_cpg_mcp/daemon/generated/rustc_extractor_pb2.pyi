...
class ExtractorHelloAck(_message.Message):
    __slots__ = ("protocol_major", "protocol_minor", "negotiated_feature_bits", "daemon_build", "output_schema_bundle_digest", "sandbox_profile_digest", "maximum_outstanding_frames", "maximum_unacknowledged_bytes", "accepted_resource_profile_id", "provider_deadline_unix_ms")
    PROTOCOL_MAJOR_FIELD_NUMBER: _ClassVar[int]
    PROTOCOL_MINOR_FIELD_NUMBER: _ClassVar[int]
    ...
    MAXIMUM_OUTSTANDING_FRAMES_FIELD_NUMBER: _ClassVar[int]
...
class CompilationAccepted(_message.Message):
    __slots__ = ("provider_run_id", "compilation_unit_id", "accepted_generation", "granted_frame_credits", "granted_credit_bytes")
    PROVIDER_RUN_ID_FIELD_NUMBER: _ClassVar[int]
    COMPILATION_UNIT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, provider_run_id: _Optional[str] = ..., compilation_unit_id: _Optional[str] = ..., accepted_generation: _Optional[int] = ..., granted_frame_credits: _Optional[int] = ..., granted_credit_bytes: _Optional[int] = ...) -> None: ...
...
class CompilationEnd(_message.Message):
    __slots__ = ("provider_run_id", "compilation_unit_id", "sequence", "compiler_exit_status", "closed_owner_set_digest", "capability_outcomes", "overall_stream_digest", "terminal_state", "rejection_error")
    PROVIDER_RUN_ID_FIELD_NUMBER: _ClassVar[int]
    COMPILATION_UNIT_ID_FIELD_NUMBER: _ClassVar[int]
    SEQUENCE_FIELD_NUMBER: _ClassVar[int]
...
class ExtractorCommand(_message.Message):
    ...
    def __init__(self, compilation_accepted: _Optional[_Union[CompilationAccepted, _Mapping]] = ..., cancel: _Optional[_Union[CancelCompilationRequest, _Mapping]] = ..., relation_ipc_ack: _Optional[_Union[_provider_control_pb2.RelationIpcFrame, _Mapping]] = ...) -> None: ...
...
class ExtractionEvent(_message.Message):
    __slots__ = ("compilation_begin", "owner_begin", "owner_end", "compilation_end", "owner_relation_ipc_frame")
    ...
    def __init__(self, compilation_begin: _Optional[_Union[CompilationBegin, _Mapping]] = ..., owner_begin: _Optional[_Union[OwnerBegin, _Mapping]] = ..., owner_end: _Optional[_Union[OwnerEnd, _Mapping]] = ..., compilation_end: _Optional[_Union[CompilationEnd, _Mapping]] = ..., owner_relation_ipc_frame: _Optional[_Union[OwnerRelationIpcFrame, _Mapping]] = ...) -> None: ...
