...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in contracts/rpc/rustc_extractor_pb2_grpc.py depends on'
...
def add_RustcExtractorServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'codefabric.rustc.v1.RustcExtractor', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('codefabric.rustc.v1.RustcExtractor', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class RustcExtractor:
    """Missing associated documentation comment in .proto file."""
    ...
    def Handshake(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/codefabric.rustc.v1.RustcExtractor/Handshake',
            contracts_dot_rpc_dot_rustc__extractor__pb2.ExtractorHello.SerializeToString,
            contracts_dot_rpc_dot_rustc__extractor__pb2.ExtractorHelloAck.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
