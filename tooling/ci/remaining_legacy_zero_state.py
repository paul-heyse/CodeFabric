...
RELEASED_EVIDENCE_GLOBS = (
    ...
    "contracts/acceptance/relational-fabric-v4/**",
)
...
STRUCTURAL_QUERIES = (
    ("python", "from tooling.ci.production_evidence import $$$N"),
    ("python", "import tooling.ci.production_evidence"),
    ("python", "from tooling.ci.successor_evidence_issuance import $$$N"),
    ("python", "import tooling.ci.successor_evidence_issuance"),
    ("python", "from tooling.ci.successor_evidence_contracts_v4 import $$$N"),
    ("python", "import tooling.ci.successor_evidence_contracts_v4"),
    ("python", "from tooling.ci.successor_evidence_issuance_v4 import $$$N"),
    ("python", "import tooling.ci.successor_evidence_issuance_v4"),
    ("python", "from tooling.ci.relational_fabric_release import $$$N"),
    ("python", "import tooling.ci.relational_fabric_release"),
    ("python", "from tooling.ci.successor_certification import $$$N"),
    ("python", "import tooling.ci.successor_certification"),
    ("python", "from tooling.ci.supervisor_launch_contract_v4 import $$$N"),
    ("python", "import tooling.ci.supervisor_launch_contract_v4"),
